...
- **AND** the `/codex-pro:setup` skill becomes available
...
- **AND** the `/codex-pro:setup` skill becomes available without needing to add the marketplace first
